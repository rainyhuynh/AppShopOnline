            ...
            <View style={wrapper}>
                <View style={mapContainer}>
                    <MapView
                        ...
                        initialRegion={{
                            latitude: 10.81331,
                            longitude: 106.6633933,
                            latitudeDelta: 0.0922,
                            longitudeDelta: 0.0421,
                        }}
                    >
                        <MapView.Marker
                            coordinate={{ latitude: 10.81331, longitude: 106.6633933 }}
                            title="My Shop"
                ...
                <View style={infoContainer}>
                    <View style={rowInfoContainer}>
                        ...
                        <Text style={infoText}>60 Truong Son street, ward 2, Tan Binh district, HCM.</Text>
                    </View>
                    <View style={rowInfoContainer}>
                        <Image source={phoneIcon} style={imageStyle} />
                        <Text style={infoText}>(+84) 0977 973 155</Text>
                    </View>
                    <View style={rowInfoContainer}>
                        <Image source={mailIcon} style={imageStyle} />
                        <Text style={infoText}>rainyhuynh@gmail.com</Text>
                    </View>
                    <View style={[rowInfoContainer, { borderBottomWidth: 0 }]}>
                        <Image source={messageIcon} style={imageStyle} />
                        <Text style={infoText}>(+84) 2838 475 475</Text>
                    </View>
                </View>
            </View>
        )
